...
@Component({
    selector: 'app-isg-screenwriters',
    templateUrl: './isg-screenwriters.view.html',
    styleUrls: ['./isg-screenwriters.view.scss']
})
export class IsgScreenwritersView implements OnInit, OnDestroy, AfterViewInit {
