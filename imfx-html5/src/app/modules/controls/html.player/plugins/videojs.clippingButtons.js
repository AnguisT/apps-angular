...
videojs.plugin('clippingbuttonspopup', function (options) {
     var player = this;
...
videojs.plugin('clippingbuttons', function (options) {
     var player = this;
     player.ready(function () {
         if (!player.controlBar.getChildById('clipping_control_bar')){
             player.controlBar.addChild(
                 ...
                 }).addClass('sub-control-bar').addClass('clipping-btns-block');
         }
