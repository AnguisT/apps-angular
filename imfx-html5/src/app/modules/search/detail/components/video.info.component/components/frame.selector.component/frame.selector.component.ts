...
export class IMFXFrameSelectorComponent {
  ...
  @ViewChild('cursor') private cursor;
  @ViewChild('cursorScroll') private cursorScroll;
  @ViewChild('cursorFrame') private cursorFrame;
  @ViewChild('cursorFrameScroll') private cursorFrameScroll;
  @ViewChild('elemFull') private elemFull;
  @ViewChild('elemScroll') private elemScroll;
  @ViewChild('frame')  private frame;
