...
import MediaInsideMappingModule from "./modules/media-inside-mapping/index";
...
export const routes = [
    {path: appRouter.empty, component: MappingComponent, routerPath: appRouter.mapping, pathMatch: 'full'}
];
