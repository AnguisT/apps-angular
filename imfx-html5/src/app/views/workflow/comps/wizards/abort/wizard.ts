...
import { WorkflowWizardAbortComponentProvider } from './providers/wizard.provider';
...
export class WorkflowWizardAbortComponent {
    private data: any;
    @ViewChild('modalFooterTemplate') private modalFooterTemplate;
    constructor(private cdr: ChangeDetectorRef,
                private injector: Injector,
                public provider: WorkflowWizardAbortComponentProvider,
