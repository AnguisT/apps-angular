...
import {MyTasksWizardAbortComponentProvider} from "./providers/wizard.provider";
...
export class MyTasksWizardAbortComponent {
    @ViewChild('modalFooterTemplate') private modalFooterTemplate;
    private data: any;

    constructor(private cdr: ChangeDetectorRef,
                private injector: Injector,
                public provider: MyTasksWizardAbortComponentProvider,
