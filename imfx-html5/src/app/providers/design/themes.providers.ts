...
export class ThemesProvider {
    ...
    constructor(@Inject(ProfileService) protected profileService: ProfileService,
                @Inject(ServerStorageService) protected storageService: ServerStorageService) {
        this.themeChangedSubscriber();
    }
    ...
    /**
     * Subscriber on changing theme
     */
    protected themeChangedSubscriber() {
        this.profileService.colorSchemaChanged.subscribe(
            (res) => {
                this.theme_class = res;
                this.storageService.store(this.storagePrefix, this.theme_class).subscribe((res) => {
