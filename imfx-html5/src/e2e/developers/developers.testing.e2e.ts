...
import {loginSimpleCase} from "./login/main";
import {mediaCases} from "./media/main";
import {caseGridViews} from "./grid/views";
import { logoutFromApp } from '../../app/tests/e2e/logout-helper';
// import {itMeida} from "./media/common";
...
describe('(e2e) Developers Testing', () => {
    beforeAll(() => {
        browser.get('./#/media');
    });
